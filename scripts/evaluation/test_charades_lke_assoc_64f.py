...
def main():
    ...
    print("Loading Charades-STA Test Dataset (64-frame)...")
    test_dataset = CharadesSTADataset(TEST_TXT, FEAT_DIR, max_seq_len=128, is_train=False)
    ...
    ckpt_path = sys.argv[1] if len(sys.argv) > 1 else config['paths'].get('model_lke_assoc_64f', './checkpoints/best_charades_sta_lke_assoc_64f_model.pt')
