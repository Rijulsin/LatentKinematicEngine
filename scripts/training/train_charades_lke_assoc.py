...
CHECKPOINT_PATH = os.path.join(CHECKPOINT_DIR, 'best_charades_sta_lke_assoc_model.pt')
...
def main():
    ...
    full_dataset = CharadesSTADataset(TRAIN_TXT, FEAT_DIR, max_seq_len=64, is_train=True)
